...
// ClusterClient is a pipeline mode redis client
...
// MakeClusterClient creates a new client
func MakeClusterClient(addr string) (*ClusterClient, error) {
...
func (client *ClusterClient) Start() {
...
func (client *ClusterClient) heartbeat() {
	for range client.ticker.C {
		client.doHeartbeat()
	}
}

func (client *ClusterClient) handleWrite() {
...
func (client *ClusterClient) Send(args [][]byte) resp.Reply {
	request := &request{
		args:      args,
		heartbeat: false,
		waiting:   &wait.Wait{},
...
func (client *ClusterClient) doHeartbeat() {
	request := &request{
		args:      [][]byte{[]byte("PING")},
		heartbeat: true,
		waiting:   &wait.Wait{},
...
func (client *ClusterClient) doRequest(req *request) {
...
func (client *ClusterClient) finishRequest(reply resp.Reply) {
	defer func() {
...
func (client *ClusterClient) handleRead() error {
